...
const columns: GridColDef[] = [
    {
        field: 'market', headerName: 'Market', width: 200, sortable: false, renderCell: (params) => {
    ...
    {field: 'liquidityShares', headerName: 'Shares', sortable: false, width: 150},
];


const LiquiditySharesTable = ({shares}) => {
...
export default LiquiditySharesTable