...
const columns: GridColDef[] = [
    ...
    {field: 'liquidityShares', headerName: 'Liquidity Shares', width: 150},
    ...
    /*    {field: 'liquidityClaimed', headerName: 'Liquidity Claimed', width: 150,},
        ...
        {field: 'yesSharesClaimedVoided', headerName: 'YesShares Claimed Voided', width: 150,},
        {field: 'noSharesClaimed', headerName: 'NoShares Claimed', width: 150,},
        {field: 'noSharesClaimedVoided', headerName: 'NoShares Claimed Voided', width: 150,},*/
];
