...
const InfoCard = observer((props: any) => {
    ...
    function handleCloseWithAnswer() {
        ...
        marketStore.closeMarketWithAnswer(market.address, isYes ? 'Y' : 'N')
            .then(() => {
    ...
    function handleCloseWithPyth() {
        marketStore.closeMarketWithPyth(marketStore.selectedMarket)
            .then(() => {
                alert("Market closed successfully");
            })
            .catch(e => {
    ...
    function handleClaimLiquidity() {
        marketStore.claimLiquidity(marketStore.selectedMarket.address)
            .then(() => {
    ...
    function handleClaimWinnings() {
        marketStore.claimWinnings(marketStore.selectedMarket.address)
            .then(() => {
